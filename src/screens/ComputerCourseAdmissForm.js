...
const ComputerCourseAdmissForm = ({ navigation }) => {
  ...
  const [isDropdownOpenStation, setDropdownOpenStation] = useState(false);
  const [selectedOptionStation, setSelectedOptionStation] = useState(null);
  const [inputValueStation, setInputValueStation] = useState("");

  //handle toggle for qualification
  const toggleDropdownStation = () => {
    setDropdownOpenStation(!isDropdownOpenStation);
  };
  const handleSelectOptionStation = (option) => {
    setSelectedOptionStation(option);
    setInputValueStation(option);
    setStation(option);
    setDropdownOpenStation(false);
  };
  const handleInputChangeStation = (text) => {
    setInputValueStation(text);
    setDropdownOpenStation(null); // Clear selected option when user edits input
  };
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior="padding">
      <Header
        title="Computer Course Admission Form"
        ...
        <View style={styles.main_content}>
          <View style={styles.profile}>
            <View style={styles.imageContainer}>
              <Image
                style={styles.img}
                source={require("../../assets/img/computer.png")}
              />
            </View>
            <View style={{ width: "80%" }}>
              <Text style={styles.profileText}>Computer Course</Text>
            </View>
          </View>
          ...
          <View style={styles.personal_details}>
            ...
            <View style={styles.input_fields}>
              ...
              <View style={styles.fields_main}>
                ...
                {!formData.police_station && fieldTouched.police_station && (
                  <Text style={{ color: "red" }}>
...
export default ComputerCourseAdmissForm;
