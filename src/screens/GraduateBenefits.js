...
const GraduateBenefits = ({ navigation }) => {
  const cards = [
    {
    ...
    {
      title: "Internship Training / Vocational training",
      image: require("../../assets/img/internship.png"),
      status: "inActive",
    },
    {
      title: "Free Apprenticeship training with Stipend",
          ...
          <View style={{ alignItems: "center", marginTop: 15 }}>
            ...
            >
              ...
              >
                ...
                <View style={styles.imgContainer}>
                  <Image source={cards[13].image} style={styles.image} />
                </View>
                <Text style={styles.textStyle}>{cards[13].title}</Text>
              </TouchableOpacity>
              <View style={styles.card}>
                {cards[2].status === "inActive" && (
                  <View style={styles.lockContainer}>
                ...
                <View style={styles.imgContainer}>
                  <Image source={cards[14].image} style={styles.image} />
                </View>
                <Text style={styles.textStyle}>{cards[14].title}</Text>
              </View>
            </View>
          </View>
...
export default GraduateBenefits;
